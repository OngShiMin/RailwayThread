...
// Abstract class extended by track, station, train maker, and sink
...
public abstract class Segment {
	...
	// When a train enters, the train:
	// 1. gets lock
	// 2. waits until there's an empty space
	// 3. enters
	// 4. release lock
